 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 5e 07 00 00       	mov    $0x75e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 0c 0a 00 00    	cmp    %eax,0xa0c
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 717:	0a 00 00 
 71a:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 10 0a 00 00       	mov    $0xa10,%eax
 729:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 730:	00 00 00 
