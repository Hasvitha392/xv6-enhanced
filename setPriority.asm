  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  24:	e8 07 04 00 00       	call   430 <printf>
		exit();
  29:	e8 94 02 00 00       	call   2c2 <exit>
	}
	else
	{
  ...
  46:	56                   	push   %esi
  47:	50                   	push   %eax
  48:	e8 2d 03 00 00       	call   37a <setPriority>
  4d:	83 c4 10             	add    $0x10,%esp
  50:	85 c0                	test   %eax,%eax
  52:	78 05                	js     59 <main+0x59>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb c8 07 00 00       	mov    $0x7c8,%ebx
        while(*s != 0){
 ...
 601:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 7c 0a 00 00    	cmp    %eax,0xa7c
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
}
 ...
 749:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 757:	0a 00 00 
 75a:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 80 0a 00 00       	mov    $0xa80,%eax
 769:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 770:	00 00 00 
