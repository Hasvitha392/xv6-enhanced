   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        ...
        if(p==0)
  20:	74 45                	je     67 <main+0x67>
    for(j=0;j<10;j++)
  22:	83 c3 01             	add    $0x1,%ebx
  25:	83 fb 0a             	cmp    $0xa,%ebx
  28:	74 23                	je     4d <main+0x4d>
        int p=fork();
  2a:	e8 fb 02 00 00       	call   32a <fork>
        if(p < 0)
  2f:	85 c0                	test   %eax,%eax
  31:	79 ed                	jns    20 <main+0x20>
            printf(1,"Fork failed\n");
  33:	83 ec 08             	sub    $0x8,%esp
    for(j=0;j<10;j++)
  36:	83 c3 01             	add    $0x1,%ebx
            printf(1,"Fork failed\n");
  39:	68 f8 07 00 00       	push   $0x7f8
  3e:	6a 01                	push   $0x1
  40:	e8 5b 04 00 00       	call   4a0 <printf>
  45:	83 c4 10             	add    $0x10,%esp
    for(j=0;j<10;j++)
  48:	83 fb 0a             	cmp    $0xa,%ebx
  4b:	75 dd                	jne    2a <main+0x2a>
  4d:	bb 0f 00 00 00       	mov    $0xf,%ebx
...
for (int i = 0; i < 15; i++)
  ...
  a4:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  a9:	7e ed                	jle    98 <main+0x98>
            for (volatile int k = 0; k < 10; k++)
  ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ae:	83 c0 01             	add    $0x1,%eax
  b1:	89 45 f4             	mov    %eax,-0xc(%ebp)
  b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  b7:	83 f8 09             	cmp    $0x9,%eax
  ba:	7f a6                	jg     62 <main+0x62>
                if(k>j)
  bc:	8b 45 f4             	mov    -0xc(%ebp),%eax
  bf:	39 d8                	cmp    %ebx,%eax
  c1:	7f bd                	jg     80 <main+0x80>
                    sleep(200); //io time
  c3:	83 ec 0c             	sub    $0xc,%esp
  c6:	68 c8 00 00 00       	push   $0xc8
  cb:	e8 f2 02 00 00       	call   3c2 <sleep>
  d0:	83 c4 10             	add    $0x10,%esp
  d3:	eb d6                	jmp    ab <main+0xab>
  d5:	66 90                	xchg   %ax,%ax
  d7:	66 90                	xchg   %ax,%ax
  d9:	66 90                	xchg   %ax,%ax
  db:	66 90                	xchg   %ax,%ax
 ...
 409:	85 d2                	test   %edx,%edx
{
 ...
 437:	f7 f1                	div    %ecx
 439:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	e9 8f fe ff ff       	jmp    4e8 <printf+0x48>
          s = "(null)";
 659:	bb 05 08 00 00       	mov    $0x805,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 6ad:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6af:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 6b4:	5b                   	pop    %ebx
 6b5:	5e                   	pop    %esi
 6b6:	5f                   	pop    %edi
 ...
 6c6:	72 ce                	jb     696 <free+0x26>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 b4 0a 00 00       	mov    %eax,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 47                	jae    798 <malloc+0x98>
    ...
    if(p == freep)
 751:	39 05 b4 0a 00 00    	cmp    %eax,0xab4
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 7a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 7b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 7c7:	0a 00 00 
 7ca:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 7d1:	0a 00 00 
    base.s.size = 0;
 7d4:	b8 b8 0a 00 00       	mov    $0xab8,%eax
 7d9:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 7e0:	00 00 00 
