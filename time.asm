  ...
  12:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2f:	50                   	push   %eax
  30:	e8 5d 03 00 00       	call   392 <waitx>
			printf(1, "Wait Time = %d\nRun Time = %d \nWith Status %d \n", a, b, status);
  35:	89 04 24             	mov    %eax,(%esp)
  38:	ff 75 f4             	pushl  -0xc(%ebp)
  3b:	ff 75 f0             	pushl  -0x10(%ebp)
  3e:	68 d0 07 00 00       	push   $0x7d0
  43:	6a 01                	push   $0x1
  ...
  4a:	83 c4 20             	add    $0x20,%esp
	...
	exit();
  4d:	e8 90 02 00 00       	call   2e2 <exit>
			if(exec(argv[1], &argv[1])==-1)
  52:	8d 43 04             	lea    0x4(%ebx),%eax
  55:	51                   	push   %ecx
  56:	51                   	push   %ecx
  57:	50                   	push   %eax
  58:	ff 73 04             	pushl  0x4(%ebx)
  5b:	e8 ba 02 00 00       	call   31a <exec>
  60:	83 c4 10             	add    $0x10,%esp
  63:	83 c0 01             	add    $0x1,%eax
  66:	75 e5                	jne    4d <main+0x4d>
				printf(1, "Exec %s Failed\n", argv[1]);
  68:	52                   	push   %edx
  69:	ff 73 04             	pushl  0x4(%ebx)
  6c:	68 bf 07 00 00       	push   $0x7bf
  71:	6a 01                	push   $0x1
  73:	e8 d8 03 00 00       	call   450 <printf>
				exit();
  78:	e8 65 02 00 00       	call   2e2 <exit>
		printf(1, "Usage: time <process>\n");
  7d:	53                   	push   %ebx
  7e:	53                   	push   %ebx
  7f:	68 a8 07 00 00       	push   $0x7a8
  84:	6a 01                	push   $0x1
  86:	e8 c5 03 00 00       	call   450 <printf>
		exit();
  8b:	e8 52 02 00 00       	call   2e2 <exit>
...
free(void *ap)
{
 ...
 621:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 b0 0a 00 00    	cmp    %eax,0xab0
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 777:	0a 00 00 
 77a:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 b4 0a 00 00       	mov    $0xab4,%eax
